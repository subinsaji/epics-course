...
/* Generated from ../O.Common/exercise.dbd */
...
epicsShareExtern dset *pvar_dset_asynAiInt64;
...
epicsShareExtern dset *pvar_dset_asynAoInt64;
...
epicsShareExtern dset *pvar_dset_asynLiInt64;
...
epicsShareExtern dset *pvar_dset_asynLoInt64;
...
epicsShareExtern void (*pvar_func_utilityRegister)(void);
epicsShareExtern void (*pvar_func_utilityRegisterPing)(void);
...
epicsShareExtern void (*pvar_func_pmacCSControllerRegister)(void);
epicsShareExtern void (*pvar_func_pmacAsynIPPortRegister)(void);
epicsShareExtern void (*pvar_func_register_func_servo)(void);
...
int exercise_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/scratch/wks59344/course/ioc";
    ...
    (*pvar_func_utilityRegister)();
    (*pvar_func_utilityRegisterPing)();
    ...
    (*pvar_func_pmacCSControllerRegister)();
    (*pvar_func_pmacAsynIPPortRegister)();
    (*pvar_func_register_func_servo)();
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"exercise_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    exercise_registerRecordDeviceDriver(*iocshPpdbbase);
}
